...
var exponent = function(base, exp) {
  ...
  if (exp === -1) {
    return Number((1 / base).toFixed(5));
  }
  if (exp === 0) {
    return 1;
  }
  if (exp > 0) {
    ...
    return Number((1 / base).toFixed(5)) * Number((exponent(base, exp + 1)).toFixed(5));
  }
};
...
var createArray = function(str) {
  ...
  output.unshift(str.charAt(0));
  output = output.concat(createArray(str.substr(1, str.length - 1)))
...
var reverseArr = function (array) {
  ...
  output = output.concat(reverseArr(array));
...
var buildList = function(value, length) {
  ...
  output.push(value);
  output = output.concat(buildList(value, length - 1));
...
var capitalizeWords = function(array) {
  ...
  output.push(array.shift().toUpperCase());
  output = output.concat(capitalizeWords(array));
